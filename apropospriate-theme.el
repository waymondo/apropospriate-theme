...
(deftheme apropospriate)

(defgroup apropospriate nil
  "Aproprospriate theme options."
  :group 'faces)

(defcustom apropospriate-theme-variant 'dark
  "The default theme variant for `apropospriate-theme'."
  :group 'apropospriate
...
(let* ((class '((class color) (min-colors 89)))
       (base00   (if (apropospriate-light?) "#FAFAFA" "#424242"))
       (base01   (if (apropospriate-light?) "#90A4AE" "#757575"))
       (base02   (if (apropospriate-light?) "#78909C" "#9E9E9E"))
       (base03   (if (apropospriate-light?) "#546E7A" "#E0E0E0"))
       (yellow   (if (apropospriate-light?) "#FFA000" "#FFEE58"))
       (yellow-1 (if (apropospriate-light?) "#FFD600" "#FFF59D"))
       (brown    (if (apropospriate-light?) "#4E342E" "#BCAAA4"))
       (brown-1  (if (apropospriate-light?) "#6D4C41" "#D7CCC8"))
       (orange   (if (apropospriate-light?) "#D84315" "#FFCC80"))
       (orange-1 (if (apropospriate-light?) "#FF5722" "#FFA726"))
       (red      (if (apropospriate-light?) "#D50000" "#E57373"))
       (red-1    (if (apropospriate-light?) "#FF1744" "#D32F2F"))
       (pink     (if (apropospriate-light?) "#F8BBD0" "#F8BBD0"))
       (pink-1   (if (apropospriate-light?) "#EC407A" "#FF80AB"))
       (purple   (if (apropospriate-light?) "#7E57C2" "#E1BEE7"))
       (purple-1 (if (apropospriate-light?) "#B388FF" "#9575CD"))
       (blue     (if (apropospriate-light?) "#42A5F5" "#64B5F6"))
       (blue-1   (if (apropospriate-light?) "#1E88E5" "#42A5F5"))
       (indigo   (if (apropospriate-light?) "#5C6BC0" "#C5CAE9"))
       (indigo-1 (if (apropospriate-light?) "#9FA8DA" "#7986CB"))
       (cyan     (if (apropospriate-light?) "#0097A7" "#80DEEA"))
       (cyan-1   (if (apropospriate-light?) "#00B8D4" "#26C6DA"))
       (teal     (if (apropospriate-light?) "#26A69A" "#80CBC4"))
       (teal-1   (if (apropospriate-light?) "#00897B" "#4DB6AC"))
       (green    (if (apropospriate-light?) "#66BB6A" "#C5E1A5"))
       (green-1  (if (apropospriate-light?) "#558B2F" "#F4FF81"))
       (base00-1 (if (apropospriate-light?)
                     (color-lighten-name base00 3)
                   (color-darken-name base00 3)))
       (base00-2 (if (apropospriate-light?)
                     (color-lighten-name base00 5)
                   (color-darken-name base00 5)))
       (base00-3 (if (apropospriate-light?)
       ...
       (base00+3 (if (apropospriate-light?)
                     (color-darken-name base00 10)
                   (color-lighten-name base00 10)))
       (mode-line-box-color (if (apropospriate-light?) base00+3 base00-3))
       (highlight-line-color (if (apropospriate-light?) base00-1 base00+1)))

  (apply 'custom-theme-set-faces 'apropospriate
         (mapcar
...
;;;###autoload
(defun apropospriate-theme-toggle-variant ()
  "Toggle between light and dark versions of `apropospriate-theme'."
  (interactive)
  (setq apropospriate-theme-variant (if (apropospriate-light?) 'dark 'light))
  (load-theme 'apropospriate :no-confirm)
  (when (and highlight-tail-mode (fboundp 'highlight-tail-reload))
    (highlight-tail-reload)))

(provide-theme 'apropospriate)
